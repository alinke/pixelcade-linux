...
/userdata/system/pixelcade/jdk/bin/java -jar -Dioio.SerialPorts=${PixelcadePort} pixelweb.jar -b -s -a & >/dev/null 2>&1 #-a flag means run pixelcade and then quit
last_pid=$!
...
/userdata/system/pixelcade/jdk/bin/java -jar -Dioio.SerialPorts=${PixelcadePort} pixelweb.jar -b -s -e & >/dev/null 2>&1 # -e is the easter egg flag
