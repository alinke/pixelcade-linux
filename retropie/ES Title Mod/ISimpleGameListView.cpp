...
bool ISimpleGameListView::input(InputConfig* config, Input input)
{
	...
	SystemData* system = this->mRoot->getSystem();
    	if (system != NULL) {
            //Scripting::fireEvent("game-select", system->getName(), cursor->getFileName(), cursor->getDisplayName(), "input");
						Scripting::fireEvent("game-select", cursor->getDisplayName(), cursor->getDisplayName(), cursor->getDisplayName(), "input");
        }
	else
	{
